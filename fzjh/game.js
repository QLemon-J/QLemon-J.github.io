...
(function (t) {
    ...
    (function (t) {
        ...
        p.resetUnhandledRejections = b, p.getUnhandledReasons = function () {
            ...
            return function () {
                ...
                var i = n.concat(K(arguments)), o = l();
    ...
    f.getGameConfig = function () {
        ...
        var e = h.defer(), n = "http://api.configar.org/cf/pb/1/configs", r = t.portal.siteId, i = t.portal.channelId, o = t.portal.applicationId;
        return SpilGames(["Net", "JSLib"], function (t, a) {
            t.send({url: [n, i, r, o].join("/"), type: "GET", dataType: "JSON"}, function (t) {
                if (t && t.configar)window.postMessage(new c({type: "success", callbackId: null, data: "log.configar.getBranding.success"}), "*"), e.resolve(t.configar); else {
                    var n = {};
                    try {
    ...
    g.argsToArray = function (t) {
        ...
        if (g.isA10())return window.onkeydown = this.disableKeys, {IS_MASTER: !0, IS_SLAVE: !0, IS_STANDALONE: !0};
        if (t) {
        ...
        } else e ? (window.onkeydown = this.disableKeys, this.trackGA(), n = {IS_MASTER: !1, IS_SLAVE: !0, IS_STANDALONE: !1}) : (window.onkeydown = this.disableKeys, this.trackGA(), n = {IS_MASTER: !0, IS_SLAVE: !0, IS_STANDALONE: !0});
        return n
        ...
        for (var n in e)if (e.hasOwnProperty(n)) {
            ...
            if (t.hasOwnProperty(n)) {
                ...
                if (e[n].constructor.name !== r)return{error: "Wrong value type for " + n + ": expected " + t[n] + ", got " + e[n].constructor.name};
                var i = t[n] && t[n].values || [];
                if (-1 === i.indexOf(e[n]))return{error: "Wrong value for " + n + ": expected " + i.join(" or ") + ", got " + e[n]}
            }
        }
        return{error: !1}
    };
    ...
    m.getGameConfig = function () {
        ...
        var n = {}, r = {configar: {branding: {main: {label: "main", image: "images/logo_A10_202x50.png", url: "", style: "", width: "202", height: "50", mime: "image/png", type: "png", handler: "newTab", blacklisted: !0}, logo: {label: "logo", image: "images/logo_A10_202x50.png", url: "#", style: "", width: "202", height: "50", mime: "image/png", type: "png", handler: "newTab", blacklisted: !1}, more_games: {label: "more_games", image: null, url: "#", style: "", width: null, height: null, mime: null, type: null, handler: "newTab", blacklisted: !1}, splash_screen: {label: "splash_screen", image: "place_holder_string", url: "#", style: "", width: "0", height: "0", mime: "image/png", type: "png", handler: "newTab", blacklisted: !1}}}};
        n.JSLib = {memory: {}, _channels: {}, get: function (t) {
            ...
            if (200 === n && "string" == typeof i && JSON.parse(i)) {
                var o = JSON.parse(i);
                e.call(this, {branding: o.configar && o.configar.branding ? o.configar.branding : r.configar.branding, portal: {applicationId: t.id, siteId: t.site ? t.site : 500, channelId: t.channel ? t.channel : 100}})
            } else e.call(this, {branding: r.configar.branding})
        }) : e.call(this, {branding: r.configar.branding})
    }, m.getCachedConfig = function () {
    }, e.prototype.newTab = function (t) {
        var e = window.navigator.userAgent.toLowerCase().match(/android.*applewebkit\/([\d.]+)/), n = e && 537 > e[1], r = n ? "_self" : "_blank", i = t.url, o = window.open(i, r);
        return o && o.focus(), o
        ...
        var e = document.createElement("div"), n = t.url, r = t.action, i = t.callback;
        ...
        var n, r, i = null;
        return this.get(t) ? (n = "update", i = this.get(t)) : n = "new", this.put(t, e), r = Date.parse(new Date), this.notify({type: n, key: t, current: e, previous: i, timestamp: r}), e
        ...
        if (this.IS_MASTER) {
            var e = new c({type: "datachange", callbackId: null, data: t}).encode();
            return window.postMessage(e, "*"), e
        }
    }, r.prototype._performAction = function (t) {
        var e = new c(t.data || {}), n = this.messenger, r = this.subscribers || {};
        if (e && e.type && e.data)switch (e.type) {
            case"gameEvent":
                ...
                }) : e.data[0] && e.data[1] && "slave" === e.data[1].origin && "function" == typeof SWFtoJS && SWFtoJS({call: e.data[0], params: {}});
                break;
            case"gameState":
        ...
        if (!this.moduleReady)throw Error("This method cannot be called before the API is loaded");
        return this.IS_MASTER ? "function" == typeof SWFtoJS && SWFtoJS({call: "UPDATE_HIGHSCORE", params: {score: t}}) : (this.messenger._postMessage(t, void 0, "gameapi.score"), this.messenger._postMessage(["log.gameapi.score.submit", {origin: "slave", score: t}, null], null, "log")), {success: !0, value: t}
        ...
        if (!this.moduleReady)throw Error("This method cannot be called before the API is loaded");
        this._validateEvent(t) ? this.IS_MASTER ? "function" == typeof SWFtoJS && SWFtoJS({call: t}) : (this.messenger._postMessage(t, void 0, "gameapi.gameevent"), this.messenger._postMessage(["log.gameapi.gameevent.emit", {origin: "slave", evt: t}, null], null, "log")) : this.IS_MASTER || this.messenger._postMessage(["log.gameapi.gameevent.emit", {origin: "slave"}, null], null, "log")
    }, s.prototype.init = function (t) {
        t = t || {}, this.data = t.data || this.data;
        var e = this.data && this.data.game && this.data.game.applicationId ? this.data.game.applicationId : null, n = new Date, r = window.location.hostname;
        ...
        var e = this.gamePlayTracking.gid, n = this.gamePlayTracking.timestamp, r = this.gamePlayTracking.host, i = this._createEventObject("game", "gameplay", {applicationId: e, start: n, host: r});
        return this._sendSETEvent("express", i, t), i
    }, s.prototype.trackTimeInGame = function (t) {
        if (!this.timeInGameTracking.started)return!1;
        var e = this.timeInGameTracking.gid, n = this.timeInGameTracking.timestamp, r = this._createEventObject("game", "heartbeat", {applicationId: e, start: n});
        return this._sendSETEvent("express", r, t), r
    }, s.prototype.startInternalTracking = function (t, e, n) {
        var r = this, i = 6e4, o = function (t) {
        ...
        return this.moduleReady ? t ? (this.gamePlayTracking.gid = t, this.gamePlayTracking.timestamp = Date.parse(e), this.gamePlayTracking.host = n, this.gamePlayTracking.started = !0, this.timeInGameTracking.gid = t, this.timeInGameTracking.timestamp = Date.parse(e), this.timeInGameTracking.started = !0, this.trackGamePlay(function (t) {
            ...
            r.trackTimeInGame(o)
        }, i), this.gamePlayTracking.started && this.timeInGameTracking.started) : {error: "No application ID defined for this game"} : {error: "This method cannot be called before the API is loaded"}
        ...
        var n, r, i = {type: {type: "String", values: ["png"]}, width: "Number", height: "Number"};
    ...
    */}, u.prototype.getLinks = function () {
        ...
        var e = this.data && this.data.branding ? this.data.branding : {}, n = e[t], r = n.handler, i = this._tagUrl(n.url, t);
        if (n.url && n.url.length > 0 && r && this.components[r]) {
            var o = this.IS_MASTER ? "master" : "slave";
            return this.messenger._postMessage(["log.branding.linkAction", {origin: o, linkName: t}, null], null, "log"), this.components[r]({url: i})
        }
        return function () {
        }
    ...
    */}, c.prototype.encode = function () {
        ...
        var r, i;
        r = g.isArray(t) && "function" == typeof t[t.length - 1] ? this._callbacks.push(t.pop()) - 1 : e, i = new c({type: n || "jslib", callbackId: r, data: t}).encode(), this._target.postMessage(i, "*")
        ...
        if (o)switch (e = o.data[0], n = o.callbackId, r = o.data[1] ? o.data[1] : null, e) {
            ...
            case"GameAPI.isReady":
                i._postMessage({isready: this.api.isReady}, n, "ugapi")
        }
        ...
        function r(e) {
            return c.IS_MASTER && (e = i(e)), c.isReady = !0, c.Branding.moduleReady = !0, c.__.EventTracking.moduleReady = !0, c.GameBreak.moduleReady = !0, c.Game.moduleReady = !0, c.Score.moduleReady = !0, c.GameEvent.moduleReady = !0, c.Branding.init({data: e}), c.__.EventTracking.init({data: e}), c.GameBreak.init(), c.__.messenger._postMessage(["log.gameapi.loadapi.finish", {origin: p, version: c.version}, null], null, "log"), t(c)
        }

        function i(t) {
            var e = t.game || {}, n = t.user || {}, r = t.portal || {}, i = t.branding || {};
            return m.getLocalConfig({game: e, user: n, portal: r, branding: i})
        }
        ...
        function a() {
            c.IS_STANDALONE = !0, c.IS_MASTER = !0, c.IS_SLAVE = !0, c.__.dataStore = new n({isMaster: !0}), e = e || null, m.setupStandaloneMode(e, function (t) {
    ...
    window.hasOwnProperty("AudioContext") && (window.webkitAudioContext = AudioContext, AudioContext.prototype.hasOwnProperty("internal_createGain") || (AudioContext.prototype.internal_createGain = AudioContext.prototype.createGain, AudioContext.prototype.createGain = function () {
        ...
        var t = this.internal_createPanner(), e = {EQUALPOWER: "equalpower", HRTF: "HRTF", LINEAR_DISTANCE: "linear", INVERSE_DISTANCE: "inverse", EXPONENTIAL_DISTANCE: "exponential"};
        for (var n in e) {
            var r = e[n];
